...
void test_validate_my_username()
{
    ...
    const char* nameFromMethod = my_username();
    const char* nameFromFile = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(nameFromMethod, nameFromFile,"Names does not match!");
}
